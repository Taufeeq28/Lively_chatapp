      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-10 lg:px-6">
        <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-16">
          ...
          <p className="mb-5 font-light sm:text-xl text-gray-400">
            Here at Lively we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.
          </p>
        </div>
        ...
        <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-white bg-gray-800 rounded-lg border border-gray-600 shadow">
            ...
            <a
              href="#"
              className="text-white hover:bg-[#1B57E9] bg-primary-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
            >
              Get started
            </a>
          </div>
